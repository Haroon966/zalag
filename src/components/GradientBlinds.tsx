...
`;
    ...
    type UniformInt = { value: number };
    type GradientUniforms = {
      iResolution: UniformVec3;
      iMouse: { value: [number, number] };
      iTime: UniformFloat;
      uAngle: UniformFloat;
      uNoise: UniformFloat;
      uBlindCount: UniformFloat;
      uSpotlightRadius: UniformFloat;
      uSpotlightSoftness: UniformFloat;
      uSpotlightOpacity: UniformFloat;
      uMirror: UniformFloat;
      uDistort: UniformFloat;
      uShineFlip: UniformFloat;
      uColor0: UniformVec3;
      uColor1: UniformVec3;
      uColor2: UniformVec3;
      uColor3: UniformVec3;
